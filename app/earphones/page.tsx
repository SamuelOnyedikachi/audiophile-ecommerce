          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left lg:w-1/2">
            ...
            <Link href={product.href} className="btn">
              See Product
                  ...
                  {/* === CATEGORY CARDS === */} 
                  <section className="max-w-7xl mx-auto grid md:grid-cols-3 gap-8 md:gap-4 lg:gap-8 px-6 md:px-10 lg:px-16 py-20 bg-[#ffffff]">
                    {[
                      {
                        title: 'Headphones',
                      ...
                      <div
                        key={item.title}
                        className="bg-[#f1f1f1] rounded-xl flex flex-col items-center justify-end h-48 md:h-40 pb-6 relative"
                      >
                        {/* Floating image */}
                        ...
                        <section className="max-w-7xl mx-auto px-6 py-16 md:py-24">
                          <div className="flex flex-col-reverse lg:flex-row items-center text-center lg:text-left gap-12 lg:gap-8">
