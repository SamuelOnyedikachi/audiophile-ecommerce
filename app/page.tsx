...
export default function Home() {
  return (
    <div className="w-full overflow-x-hidden">
      {/* === HERO SECTION === */}
      <section className="bg-[#121212] text-white">
        <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between px-6 md:px-10 py-20 md:py-32">
          {/* Text content */}
          <div className="text-center md:text-left space-y-6 md:max-w-lg mt-10 md:mt-0">
            <p className="uppercase text-sm md:text-2xl text-gray-400 tracking-[0.3em]">
              New Product
            </p>
            ...
            <Link
              href="/product/xx99-mark-two-headphones"
              className="inline-block mt-4 bg-orange-600 hover:bg-orange-500 text-white font-semibold px-6 py-3 rounded-lg transition"
            >
              See Product
            </Link>
          </div>
          ...
          <div className="flex justify-center">
            <Image
              ...
              width={500}
              height={500}
              className="rounded-lg object-contain w-[80%] sm:w-[60%] md:w-[500px]"
              priority
            />
          </div>
        </div>
